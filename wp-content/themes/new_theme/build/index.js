...
const slider = new _modules_Slider__WEBPACK_IMPORTED_MODULE_1__["default"]();
...
class Slider {
  constructor() {
    ...
    if (document.querySelector(".carousel-inner")) {
      ...
      this.dotCount = this.slides.length; // Generate the HTML for the navigation dots
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkwestsidescooter"] = self["webpackChunkwestsidescooter"] || [];
